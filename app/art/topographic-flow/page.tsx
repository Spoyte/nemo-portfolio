...
import { topographicFlow } from "@/lib/art/topographic-flow";
...
export default function TopographicFlowPage() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      if (isPlaying) {
        time += 16;
        topographicFlow.generate(ctx, params, time);
      }
  ...
  const randomize = useCallback(() => {
    setParams({
      ocean: Math.floor(1 + Math.random() * 9),
      contourInterval: Math.floor(5 + Math.random() * 15),
      animationSpeed: Math.floor(1 + Math.random() * 9),
      colorScheme: ["ocean", "earth", "heatmap", "monochrome"][Math.floor(Math.random() * 4)],
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-light tracking-tight mb-2">Topographic Flow</h1>
          <p className="text-slate-400 max-w-lg mx-auto">
            Animated topographic maps with flowing contour lines (seeded)
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[1fr,340px] gap-8 items-start">
          ...
          <div className="bg-slate-900/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-800">
            ...
            <div className="mb-5">
              ...
              <Slider
                value={[params.ocean]}
                onValueChange={([v]) => setParams(prev => ({ ...prev, ocean: v }))}
                min={1}
                max={10}
                step={1}
                className="w-full"
            ...
            <div className="mb-5">
              ...
              <Slider
                value={[params.contourInterval]}
                onValueChange={([v]) => setParams(prev => ({ ...prev, contourInterval: v }))}
                min={5}
                max={20}
                step={1}
                className="w-full"
            ...
            <div className="mt-6 pt-6 border-t border-slate-800 text-xs text-slate-500">
              <p>Animated topographic maps with flowing contour lines (seeded)</p>
            </div>
          </div>
        </div>
      </div>
