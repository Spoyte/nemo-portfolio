...
import { particleSwarm } from "@/lib/art/particle-swarm";
...
export default function ParticleSwarmPage() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      if (isPlaying) {
        time += 16;
        particleSwarm.generate(ctx, params, time);
      }
  ...
  const randomize = useCallback(() => {
    setParams({
      params: 50 + Math.random() * 450,
      speed: 10 + Math.random() * 90,
      attraction: 0 + Math.random() * 100,
      cohesion: 0 + Math.random() * 100,
      trail: 0 + Math.random() * 100,
      colorScheme: ["fire", "ocean", "neon", "monochrome"][Math.floor(Math.random() * 4)],
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-light tracking-tight mb-2">Particle Swarm</h1>
          <p className="text-slate-400 max-w-lg mx-auto">
            Flocking particles with emergent behavior (seeded)
          </p>
        </div>
          ...
          <div className="bg-slate-900/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-800">
            ...
            <div className="mb-5">
              ...
              <Slider
                ...
                onValueChange={([v]) => setParams(prev => ({ ...prev, attraction: v }))}
                min={0}
                max={100}
                step={5}
                className="w-full"
            ...
            <div className="mb-5">
              ...
              <Slider
                ...
                onValueChange={([v]) => setParams(prev => ({ ...prev, cohesion: v }))}
                min={0}
                max={100}
                step={5}
                className="w-full"
            ...
            <div className="mt-6 pt-6 border-t border-slate-800 text-xs text-slate-500">
              <p>Flocking particles with emergent behavior (seeded)</p>
            </div>
          </div>
        </div>
      </div>
