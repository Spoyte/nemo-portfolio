...
import { waveInterference } from "@/lib/art/wave-interference";
...
export default function WaveInterferencePage() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      if (isPlaying) {
        time += 16;
        waveInterference.generate(ctx, params, time);
      }
  ...
  const randomize = useCallback(() => {
    setParams({
      ...
      frequency: 0.005 + Math.random() * 0.045000000000000005,
      amplitude: 0.5 + Math.random() * 1.5,
      phaseShift: 0 + Math.random() * 360,
    });
  }, []);
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-light tracking-tight mb-2">Wave Interference</h1>
        ...
        <div className="grid lg:grid-cols-[1fr,340px] gap-8 items-start">
          ...
          <div className="bg-slate-900/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-800">
            ...
            <div className="mt-6 pt-6 border-t border-slate-800 text-xs text-slate-500">
              <p>Overlapping sine waves creating interference patterns</p>
            </div>
          </div>
        </div>
      </div>
