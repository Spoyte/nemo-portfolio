...
export const GENERATOR_REGISTRY: GeneratorEntry[] = [
  ...
  // === MISSING ALGORITHMS - BATCH 1 (Mathematical/Geometric) ===
  {
    id: "mandelbrot",
    name: "Mandelbrot",
    description: "Classic Mandelbrot set fractal with smooth coloring and orbit trap visualization",
    category: "mathematical",
    loader: () => import("./mandelbrot"),
    renderFnName: "renderMandelbrot",
    importName: "mandelbrot",
  },
  {
    id: "apollonian-gasket",
    name: "Apollonian Gasket",
    description: "Recursive circle packing fractal - infinitely tangent circles in a bounded space",
    category: "geometric",
  ...
  },
  {
    id: "hypercube",
    name: "Hypercube",
    description: "4D tesseract rotating in 3D projection - glimpse higher dimensions",
    category: "geometric",
  ...
  },
  {
    id: "mobius-strip",
    name: "Mobius Strip",
    description: "One-sided surface with continuous twist - topology made visible",
    category: "geometric",
  ...
  },
  {
    id: "moebius-strip",
    name: "Moebius Strip",
    description: "Alternative rendering of the iconic one-sided topological surface",
    category: "geometric",
  ...
  // === MISSING ALGORITHMS - BATCH 2 (Physics/Simulation) ===
  {
    id: "gravity-well",
    name: "Gravity Well",
    description: "Particles spiraling into gravitational singularities with accretion disk effects",
    category: "physics",
    loader: () => import("./gravity-well"),
    renderFnName: "renderGravityWell",
    importName: "gravityWell",
  },
  {
    id: "flowing-magnetism",
    name: "Flowing Magnetism",
    description: "Magnetic field lines visualized as flowing particles between poles",
    category: "physics",
    loader: () => import("./flowing-magnetism"),
    renderFnName: "renderFlowingMagnetism",
    importName: "flowingMagnetism",
  },
  {
    id: "reaction-diffusion",
    name: "Reaction Diffusion",
    description: "Turing patterns emerging from chemical reaction simulations - nature's fingerprint generator",
    category: "physics",
  ...
  },
  {
    id: "kohonen-map",
    name: "Kohonen Map",
    description: "Self-organizing neural network map - high-dimensional data unfolding into 2D topology",
    category: "mathematical",
    loader: () => import("./kohonen-map"),
    renderFnName: "renderKohonenMap",
    importName: "kohonenMap",
  },
  {
    id: "neural-cellular-automata",
    name: "Neural Cellular Automata",
    description: "Deep learning meets cellular automata - neural networks evolving pixel patterns",
    category: "mathematical",
    loader: () => import("./neural-cellular-automata"),
    renderFnName: "renderNeuralCA",
    importName: "neuralCellularAutomata",
  },

  // === MISSING ALGORITHMS - BATCH 3 (Visual/Artistic) ===
  {
    id: "pointillism",
    name: "Pointillism",
    description: "Seurat-style dots forming images through color mixing - impressionism meets computation",
    category: "traditional",
  ...
  },
  {
    id: "flowing-silk",
    name: "Flowing Silk",
    description: "Cloth simulation creating elegant draped fabric movements with light refraction",
    category: "abstract",
    loader: () => import("./flowing-silk"),
    renderFnName: "renderFlowingSilk",
    importName: "flowingSilk",
  },
  {
    id: "chromatic-aberration",
    name: "Chromatic Aberration",
    description: "Prismatic light splitting - RGB channels diverging into spectral beauty",
    category: "abstract",
  ...
  },
  {
    ...
    description: "Mirror symmetry creating infinite pattern variations from simple sources",
    category: "geometric",
    loader: () => import("./kaleidoscope-symmetry"),
    renderFnName: "renderKaleidoscope",
    importName: "kaleidoscopeSymmetry",
  },

  // === MISSING ALGORITHMS - BATCH 4 (Audio/Sonic) ===
  {
    id: "sonic-typography",
    name: "Sonic Typography",
    description: "Text that responds to audio frequencies - letters dancing to the rhythm",
    category: "text",
  ...
  },
  {
    id: "sonic-bloom",
    name: "Sonic Bloom",
    description: "Audio-reactive floral patterns that bloom and pulse with sound",
    category: "abstract",
  ...
  {
    id: "sonic-harmonograph",
    name: "Sonic Harmonograph",
    description: "Sound-driven pendulum simulation - audio frequencies controlling geometric drawing",
    category: "physics",
    loader: () => import("./sonic-harmonograph"),
    renderFnName: "renderSonicHarmonograph",
    importName: "sonicHarmonograph",
  },

  // === MISSING ALGORITHMS - BATCH 5 (3D/Volumetric) ===
  {
    id: "volumetric-text",
    name: "Volumetric Text",
    description: "3D text with volumetric lighting - letters floating in light beams and fog",
    category: "3d",
  ...
  },
  {
    ...
    description: "Ray-marched cloud formations with realistic light scattering",
    category: "3d",
